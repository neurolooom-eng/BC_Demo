...
export function Logo({ collapsed = false }: { collapsed?: boolean }) {
  if (collapsed) {
    return <img src={assetUrl('/logo-mark.svg')} alt="Best Cast" className="h-8 w-auto shrink-0" />
  }

  return (
    <div className="flex min-w-0 items-center gap-2 overflow-hidden">
      <img src={assetUrl('/logo-mark.svg')} alt="Best Cast" className="h-7 w-auto shrink-0" />
