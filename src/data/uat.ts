  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        steps: ['Sign in as a non-developer role.', 'Look for Requirements and UAT in the sidebar and try the routes directly.'],
        expected: 'The Requirements and UAT pages are not listed and show "Access restricted" if opened directly.',
      },
    ],
  },
]
