  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        steps: [
          'Open Day Check Sheet → step 2 (Hourly readings).',
          'Pick a shift and time slot, enter values (incl. a machine value), and Save reading.',
          'Go to step 3 (Sign-off & print) and view the preview.',
        ],
      ...
      },
      {
        ...
        steps: [
          'In Day Check Sheet → Hourly readings (or Sheet details), add a new machine from a slot (e.g. 10.00am).',
          'View the Sign-off & print preview.',
        ],
        expected: 'The new machine shows readings from 10.00am onward and N/A for every slot before it. Earlier slots on the hourly form do not show the new machine for entry.',
      },
      {
        id: 'UAT-PCS-10',
        requirement: 'REQ-PCS-12',
        title: 'Print is gated behind in-charge sign-off',
        steps: [
          'Open Day Check Sheet → step 3 (Sign-off & print).',
          'Confirm the Print button is disabled.',
          'Enter the In-Charge name and select “Sign off & lock”.',
          'Select Print; then select “Reopen sheet”.',
        ],
        expected: 'Print is disabled until sign-off; after sign-off the sheet locks and Print works; Reopen unlocks editing and disables Print again.',
      },
      {
        id: 'UAT-PCS-11',
        ...
        steps: [
          'In Day Check Sheet → Sheet details, press Stop on a running machine (it stops from its window).',
          'In Hourly readings, check that the machine is no longer asked for from its stop slot (still present before it).',
          'View the Sign-off & print preview.',
        ],
        expected:
          'The machine is not asked for from its stop slot onward (still present before). The print shows its readings up to the stop and N/A after, to end of day. Reactivate restores it.',
      },
    ],
  },
  {
